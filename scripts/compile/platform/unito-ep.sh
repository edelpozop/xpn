...
#MPICC_PATH=$HOME/dcamarma/xpn_ep/src/mpich/bin/mpicc
 MPICC_PATH=$HOME/dcamarma/bin/mpich/bin/mpicc
 INSTALL_PATH=$HOME/dcamarma/xpn_ep/bin/
 BASE_PATH=$(dirname $0)
 export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:$INSTALL_PATH/mosquitto/lib/
